...
public enum HbmEffectNT {
    // Particle creators
    CasingNT((world, x, y, z, data) -> ParticleCreators.CASING
            .makeParticle(world, Minecraft.getMinecraft().player, Minecraft.getMinecraft().renderEngine, world.rand, x, y, z, data)),
    Flamethrower((world, x, y, z, data) -> ParticleCreators.FLAME
            .makeParticle(world, Minecraft.getMinecraft().player, Minecraft.getMinecraft().renderEngine, world.rand, x, y, z, data)),
    ExplosionSmall((world, x, y, z, data) -> ParticleCreators.EXPLOSION_SMALL
            .makeParticle(world, Minecraft.getMinecraft().player, Minecraft.getMinecraft().renderEngine, world.rand, x, y, z, data)),
    ExplosionLarge((world, x, y, z, data) -> ParticleCreators.EXPLOSION_LARGE
            .makeParticle(world, Minecraft.getMinecraft().player, Minecraft.getMinecraft().renderEngine, world.rand, x, y, z, data)),
    BlackPowder((world, x, y, z, data) -> ParticleCreators.BLACK_POWDER
            .makeParticle(world, Minecraft.getMinecraft().player, Minecraft.getMinecraft().renderEngine, world.rand, x, y, z, data)),
    Ashes((world, x, y, z, data) -> ParticleCreators.ASHES
            .makeParticle(world, Minecraft.getMinecraft().player, Minecraft.getMinecraft().renderEngine, world.rand, x, y, z, data)),
    Skeleton((world, x, y, z, data) -> ParticleCreators.SKELETON
            .makeParticle(world, Minecraft.getMinecraft().player, Minecraft.getMinecraft().renderEngine, world.rand, x, y, z, data)),

    // MK1 port
    WaterSplash((world, x, y, z, _) -> {
        for (int i = 0; i < 10; i++) {
    ...
    // MK3 stuff
    MissileContrail((world, x, y, z, data) -> {
    ...
    Smoke_RadialDigamma((world, x, y, z, data) -> {
        Random rand = world.rand;
        int count = Math.max(1, data.getInteger("count"));
    ...
    Smoke_ShockRand((world, x, y, z, data) -> {
        Random rand = world.rand;
        int count = Math.max(1, data.getInteger("count"));
        double strength = data.getDouble("strength");
    ...
    Smoke_FoamSplash((world, _, _, _, data) -> {
        Random rand = world.rand;
        int count = Math.max(1, data.getInteger("count"));
        double strength = data.getDouble("range");
    ...
    Exhaust_Soyuz((world, x, y, z, data) -> {
        Random rand = world.rand;
        EntityPlayer player = Minecraft.getMinecraft().player;
        if (new Vec3d(player.posX - x, player.posY - y, player.posZ - z).length() > 350) return;
    ...
    Exhaust_Meteor((world, x, y, z, data) -> {
        Random rand = world.rand;
        EntityPlayer player = Minecraft.getMinecraft().player;
        if (new Vec3d(player.posX - x, player.posY - y, player.posZ - z).length() > 350) return;
    ...
    RadiationFlash((world, _, _, _, data) -> {
        Random rand = world.rand;
        EntityPlayer player = Minecraft.getMinecraft().player;
        for (int i = 0; i < data.getInteger("count"); i++) {
    ...
    AmatExplosion((world, x, y, z, data) -> {
    ...
    VanillaBurst_Flame((world, x, y, z, data) -> {
    ...
    VanillaBurst_Cloud((world, x, y, z, data) -> {
        double motion = data.getDouble("motion");
        for (int i = 0; i < data.getInteger("count"); i++) {
            double mX = world.rand.nextGaussian() * motion;
            double mY = world.rand.nextGaussian() * motion;
    ...
    VanillaBurst_BlockDust((world, x, y, z, data) -> {
        double motion = data.getDouble("motion");
        for (int i = 0; i < data.getInteger("count"); i++) {
            double mX = world.rand.nextGaussian() * motion;
            double mY = world.rand.nextGaussian() * motion;
    ...
    VanillaExt_Flame((world, x, y, z, data) -> {
        double mX = data.getDouble("mX");
        double mY = data.getDouble("mY");
        double mZ = data.getDouble("mZ");
    ...
    VanillaExt_Smoke((world, x, y, z, data) -> {
        double mX = data.getDouble("mX");
        double mY = data.getDouble("mY");
        double mZ = data.getDouble("mZ");
    ...
    VanillaExt_Volcano((world, x, y, z, data) -> {
        Random rand = world.rand;
        double mX = data.getDouble("mX");
        double mY = data.getDouble("mY");
        double mZ = data.getDouble("mZ");
    ...
    VanillaExt_Cloud((world, x, y, z, data) -> {
        double mX = data.getDouble("mX");
        double mY = data.getDouble("mY");
        double mZ = data.getDouble("mZ");
    ...
    VanillaExt_RedDust((world, x, y, z, data) -> {
        double mX = data.getDouble("mX");
        double mY = data.getDouble("mY");
        double mZ = data.getDouble("mZ");
    ...
    VanillaExt_BlueDust((world, x, y, z, data) -> {
    ...
    VanillaExt_GreenDust((world, x, y, z, data) -> {
    ...
    VanillaExt_Fireworks((world, x, y, z, _) -> world.spawnParticle(EnumParticleTypes.FIREWORKS_SPARK, x, y, z, 0, 0, 0)),
    VanillaExt_LargeExplode((world, x, y, z, data) -> {
    ...
    VanillaExt_TownAura((world, x, y, z, data) -> {
        double mX = data.getDouble("mX");
        double mY = data.getDouble("mY");
        double mZ = data.getDouble("mZ");
    ...
    VanillaExt_BlockDust((world, x, y, z, data) -> {
        double mX = data.getDouble("mX");
        double mY = data.getDouble("mY");
        double mZ = data.getDouble("mZ");
        Block b = Block.getBlockById(data.getInteger("block"));
    ...
    VanillaExt_ColorDust((world, x, y, z, data) -> {
        double mX = data.getDouble("mX");
        double mY = data.getDouble("mY");
        double mZ = data.getDouble("mZ");
    ...
    Hadron((world, x, y, z, _) -> Minecraft.getMinecraft().effectRenderer.addEffect(new ParticleHadron(world, x, y, z))),
    SchrabFog((world, x, y, z, _) -> {
    ...
    Rift((world, x, y, z, _) -> Minecraft.getMinecraft().effectRenderer.addEffect(new ParticleRift(world, x, y, z))),
    RBMKFlame((world, x, y, z, data) -> {
    ...
    private final EffectHandler func;

    HbmEffectNT(EffectHandler func) {
        this.func = func;
    }
    
    public void summonParticle(World world, double x, double y, double z, @Nullable NBTTagCompound data) {
        func.summonParticle(world, x, y, z, data == null ? new NBTTagCompound() : data);
    }
