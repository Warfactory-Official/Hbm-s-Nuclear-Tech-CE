...
public class EntityBulletBaseMK4 extends EntityThrowableInterp {
    ...
    public void onUpdate() {
        ...
        if (this.lockonTarget != null && !this.lockonTarget.isDead) {
            ...
            double vel = motion.toVec3d().length();
            ...
            Vec3NT newVec = new Vec3NT(
                    ...
                    BobMathUtil.interp(motion.z, delta.z, turn)).normalizeSelf().multiply(vel);
    ...
    public void setDead() {
        ...
        if (world instanceof WorldServer) TrackerUtil.sendTeleport(world, this);
    }
