...
public class GUIMachineOilWell extends GuiInfoContainer {
	...
	private static final ResourceLocation texture = new ResourceLocation(Tags.MODID + ":textures/gui/machine/gui_well.png");
	...
	protected void drawGuiContainerForegroundLayer( int i, int j) {
		...
		this.fontRenderer.drawString(name, 126 - this.fontRenderer.getStringWidth(name) / 2, 10, 4210752);
