...
public class GUISoyuzCapsule extends GuiContainer {
	...
	private static ResourceLocation texture = new ResourceLocation(Tags.MODID + ":textures/gui/storage/gui_soyuz_capsule.png");
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		...
		this.fontRenderer.drawString(name, 115 - this.fontRenderer.getStringWidth(name) / 2, 6, 0x7daf71);
