...
public class AssemblyMachineRecipes extends GenericRecipes<GenericRecipe> {
    ...
    public void registerDefaults() {
        ...
        this.register(new GenericRecipe("ass.blastdoor").setup(200, 100).outputItems(new ItemStack(ModBlocks.blast_door, 1))
                .inputItems(new RecipesCommon.OreDictStack(STEEL.ingot(), 12), new RecipesCommon.OreDictStack(PB.plate(), 6), new RecipesCommon.OreDictStack(ANY_RUBBER.ingot(), 2), new RecipesCommon.OreDictStack(DURA.bolt(), 8), new RecipesCommon.ComparableStack(ModItems.motor, 1)));
        this.register(new GenericRecipe("ass.firedoor").setup(300, 100).outputItems(new ItemStack(ModBlocks.fire_door, 1))
                .inputItems(new RecipesCommon.OreDictStack(STEEL.plate(), 16), new RecipesCommon.OreDictStack(DURA.bolt(), 8), new RecipesCommon.ComparableStack(ModItems.motor, 2)));
        this.register(new GenericRecipe("ass.seal").setup(1_200, 100).outputItems(new ItemStack(ModBlocks.transition_seal, 1))
                .inputItems(new RecipesCommon.ComparableStack(ModBlocks.cmb_brick_reinforced, 16), new RecipesCommon.OreDictStack(STEEL.plate(), 64), new RecipesCommon.OreDictStack(ANY_RUBBER.ingot(), 36), new RecipesCommon.OreDictStack(STEEL.block(), 32), new RecipesCommon.ComparableStack(ModItems.motor_desh, 16), new RecipesCommon.OreDictStack(KEY_YELLOW, 4)));
        ...
        this.register(new GenericRecipe("ass.qedoor").setup(400, 100).outputItems(new ItemStack(ModBlocks.qe_containment, 1))
                .inputItems(new RecipesCommon.OreDictStack(STEEL.plateCast(), 6), new RecipesCommon.ComparableStack(ModItems.plate_polymer, 8), new RecipesCommon.ComparableStack(ModItems.motor, 2), new RecipesCommon.OreDictStack(DURA.bolt(), 32), new RecipesCommon.OreDictStack(KEY_BLACK, 4)));
        ...
        this.register(new GenericRecipe("ass.roundairlock").setup(400, 100).outputItems(new ItemStack(ModBlocks.round_airlock_door, 1))
                .inputItems(new RecipesCommon.OreDictStack(STEEL.plateCast(), 12), new RecipesCommon.ComparableStack(ModItems.plate_polymer, 16), new RecipesCommon.ComparableStack(ModItems.motor, 4), new RecipesCommon.OreDictStack(DURA.bolt(), 16), new RecipesCommon.OreDictStack(KEY_GREEN, 4)));
        this.register(new GenericRecipe("ass.secureaccess").setup(400, 100).outputItems(new ItemStack(ModBlocks.secure_access_door, 1))
                .inputItems(new RecipesCommon.OreDictStack(STEEL.plateCast(), 12), new RecipesCommon.ComparableStack(ModItems.plate_polymer, 8), new RecipesCommon.ComparableStack(ModItems.motor, 4), new RecipesCommon.OreDictStack(DURA.bolt(), 32), new RecipesCommon.OreDictStack(KEY_RED, 8)));
...
//                .inputItems(new RecipesCommon.OreDictStack(STEEL.plateWelded(), 4), new RecipesCommon.ComparableStack(ModItems.plate_polymer, 4), new RecipesCommon.ComparableStack(ModItems.motor, 2), new RecipesCommon.OreDictStack(STEEL.bolt(), 16), new RecipesCommon.OreDictStack(KEY_GREEN, 4)));
        ...
        this.register(new GenericRecipe("ass.satelliterelay").setup(600, 100).outputItems(new ItemStack(ModItems.satellite, 1, EnumSatType.RELAY.ordinal()))
                .inputItems(new OreDictStack(TI.shell(), 3),
                        ...
                        new ComparableStack(ModItems.magnetron, 3),
                        new ComparableStack(ModItems.battery_pack, 1, ItemBatteryPack.EnumBatteryPack.BATTERY_LITHIUM)));
        this.register(new GenericRecipe("ass.satelliteasteroidminer").setup(600, 100).outputItems(new ItemStack(ModItems.satellite, 1, EnumSatType.MINER_ASTRO.ordinal()))
                .inputItems(new OreDictStack(BIGMT.plate(), 24),
                        ...
                        new ComparableStack(ModItems.battery_pack, 1, ItemBatteryPack.EnumBatteryPack.BATTERY_LITHIUM)));
        this.register(new GenericRecipe("ass.satellitelunarminer").setup(600, 100).outputItems(new ItemStack(ModItems.satellite, 1, EnumSatType.MINER_LUNAR.ordinal()))
        ...
        this.register(new GenericRecipe("ass.nitra").setupNamed(200, 500)
                ...
                .outputItems(new ChanceOutputMulti(
                        ...
                        new ChanceOutput(new ItemStack(ModItems.grenade_shell, 1, ItemGrenadeShell.EnumGrenadeShell.FRAG.ordinal()), 5),
                        new ChanceOutput(new ItemStack(ModItems.grenade_shell, 1, ItemGrenadeShell.EnumGrenadeShell.STICK.ordinal()), 5),
                        new ChanceOutput(new ItemStack(ModItems.grenade_fuze, 1, ItemGrenadeFuze.EnumGrenadeFuze.S3.ordinal()), 10)
                )));
