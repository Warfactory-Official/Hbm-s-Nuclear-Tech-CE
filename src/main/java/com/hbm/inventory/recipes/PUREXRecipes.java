...
public class PUREXRecipes extends GenericRecipes<PUREXRecipe> {
    ...
    @Override
    public PUREXRecipe instantiateRecipe(String name) {
        return new PUREXRecipe(name);
    }
    ...
    public void registerDefaults() {
        ...
        // Molten Salt
        this.register((PUREXRecipe) new PUREXRecipe("purex.thoriumsalt").setup(100, 10_000).setIcon(ModItems.fluid_icon, Fluids.THORIUM_SALT.getID())
        ...
        this.register((PUREXRecipe) new PUREXRecipe("purex.watzschrab").setup(60, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this).inputItems(
        ...
        /// Vitrification
        this.register((PUREXRecipe) new PUREXRecipe("purex.vitliquid").setup(100, vitrification).inputItems(new ComparableStack(ModBlocks.sand_lead))
                                                          .inputFluids(new FluidStack(Fluids.WASTEFLUID, 1_000))
                                                          .outputItems(new ItemStack(ModItems.nuclear_waste_vitrified)));

        this.register((PUREXRecipe) new PUREXRecipe("purex.vitgaseous").setup(100, vitrification).inputItems(new ComparableStack(ModBlocks.sand_lead))
                                                           .inputFluids(new FluidStack(Fluids.WASTEGAS, 1_000))
                                                           .outputItems(new ItemStack(ModItems.nuclear_waste_vitrified)));

        this.register((PUREXRecipe) new PUREXRecipe("purex.vitsolid").setup(300, vitrification).inputItems(new ComparableStack(ModBlocks.sand_lead),
