...
public class ItemStructureRandomly extends ItemStructureTool {
	...
	public ItemStructureRandomly(String s) {
		super(s);
	}
	...
	public void addInformation(@NotNull ItemStack stack, @Nullable World world, @NotNull List<String> list, @NotNull ITooltipFlag flag) {
		...
		list.add(TextFormatting.YELLOW + "Click to print a <randomlyFillWithBlocks>");
		list.add(TextFormatting.YELLOW + "line with the targeted block.");
	}
	...
	protected void doTheThing(ItemStack stack, World world, BlockPos pos) {
		...
		String line = "randomlyFillWithBlocks(world, box, rand, <limit>, " + minX + ", " + minY + ", " + minZ + ", " + maxX + ", " + maxY + ", " + maxZ + ", " + state.getBlock().getTranslationKey() + ");\n";
