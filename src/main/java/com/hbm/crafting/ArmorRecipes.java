...
public class ArmorRecipes {
    ...
    public static void register() {
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.bj_plate, 1),"N N", "MSM", "NCN", 'N', ModItems.plate_armor_lunar, 'M', ModItems.motor_desh, 'S', ModItems.starmetal_plate, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ADVANCED) );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.hev_helmet, 1),"PPC", "PBP", "IFI", 'P', ModItems.plate_armor_hev, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.BASIC), 'B', ModItems.titanium_helmet, 'I', ANY_PLASTIC.ingot(), 'F', ModItems.gas_mask_filter );
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.hev_plate, 1),"MPM", "IBI", "PPP", 'P', ModItems.plate_armor_hev, 'B', ModItems.titanium_plate, 'I', ANY_PLASTIC.ingot(), 'M', ModItems.motor_desh );
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.hev_legs, 1),"MPM", "IBI", "P P", 'P', ModItems.plate_armor_hev, 'B', ModItems.titanium_legs, 'I', ANY_PLASTIC.ingot(), 'M', ModItems.motor_desh );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.fau_helmet, 1),"PWP", "PBP", "FSF", 'P', ModItems.plate_armor_fau, 'W', new ItemStack(Blocks.WOOL, 1, 14), 'B', ModItems.starmetal_helmet, 'F', ModItems.gas_mask_filter, 'S', STEEL.pipe() );
        ...
        //Hazmat
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.hazmat_helmet, 1),"EEE", "EIE", " P ", 'E', ModItems.hazmat_cloth, 'I', KEY_ANYPANE, 'P', IRON.plate() );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.hazmat_helmet_red, 1),"EEE", "IEI", "EFE", 'E', ModItems.hazmat_cloth_red, 'I', KEY_ANYPANE, 'F', IRON.plate() );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.hazmat_helmet_grey, 1),"EEE", "IEI", "EFE", 'E', ModItems.hazmat_cloth_grey, 'I', KEY_ANYPANE, 'F', IRON.plate() );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.hazmat_paa_helmet, 1),"EEE", "IEI", " P ", 'E', ModItems.plate_paa, 'I', KEY_ANYPANE, 'P', IRON.plate() );
        ...
        //Liquidator Suit
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.liquidator_helmet, 1),"III", "CBC", "III", 'I', ANY_RUBBER.ingot(), 'C', ModItems.cladding_lead, 'B', ModItems.hazmat_helmet_grey );
