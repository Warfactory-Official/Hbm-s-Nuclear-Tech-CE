...
public class CableDiodeBakedModel extends AbstractWavefrontBakedModel {
    ...
    public CableDiodeBakedModel(TextureAtlasSprite diodeSprite, TextureAtlasSprite cableSprite, boolean isInventory) {
        super(ResourceManager.cable_neo_obj, isInventory ? DefaultVertexFormats.ITEM : DefaultVertexFormats.BLOCK, 1.0F, 0.0F, 0.0F, 0.0F, BakedModelTransforms.isbrh());
    ...
    private List<BakedQuad> buildItemQuads() {
        ...
        addLegacyBox(quads, 0.0F, 12.0F, 0.0F, 16.0F, 14.0F, 16.0F, diodeSprite, LEGACY_ALL_FACES, LEGACY_NO_ROTATION);
        addLegacyBox(quads, 2.0F, 0.0F, 2.0F, 14.0F, 12.0F, 14.0F, padSprite, LEGACY_ALL_FACES, LEGACY_NO_ROTATION);
        quads.addAll(bakeSimpleQuads(Set.of("posX", "negX", "negY", "posZ", "negZ"), 0.0F, 0.0F,
                (float) Math.PI * 1.5F, true, false, cableSprite, -1, 0.5F, 0.375F, 0.5F));
        return quads;
    }
